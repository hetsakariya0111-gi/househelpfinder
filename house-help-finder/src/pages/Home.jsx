    ...
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center pb-10 border-b border-gray-200 mb-10">
        <div>
          ...
          <div className="flex gap-3 flex-wrap">
            ...
            <Link to="/register" className="border border-green-600 text-green-700 px-6 py-2.5 rounded-full text-sm font-medium hover:bg-green-50 transition-colors">
              register as worker
            </Link>
          </div>
        </div>
      ...
      <section className="mb-10">
        <div className="flex items-center justify-between mb-5">
          <h2 className="font-serif text-2xl font-semibold">featured workers</h2>
          ...
          {featuredWorkers.map((w) => (
            ...
            >
              ...
              <div className="flex flex-wrap gap-1.5 mb-3">
                ...
                <span className="text-xs px-2.5 py-1 rounded-full bg-gray-100 text-gray-600">{w.exp}</span>
              </div>
